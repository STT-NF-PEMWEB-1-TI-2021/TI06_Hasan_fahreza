    ...
    <div class="container m-5">
        ...
        <form action="#" method="post">
            <div class="d-flex justify-content-center ">
                ...
                <div class="col-md-6">
                    <input type="number" class="form-control" name="nim" required name="NIM Anda"
            ...
            <div class="d-flex justify-content-center mt-3">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" name="nama" required name="NIM Anda"
            ...
            <div class="d-flex justify-content-center mt-3">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-primary"><a style="text-decoration: none; color:white;"
                            href="class_nilaimahasiswa.php">Reset Data</a></button>
                </div>
            </div>
        </form>
